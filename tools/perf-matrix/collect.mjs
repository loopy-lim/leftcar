...
import {sha256,verifyManifest} from '../release-manifest.mjs';
...
for(const key of ['hostManifest','androidManifest','sourceManifest']) {
 ...
 if(key!=='sourceManifest')await verifyManifest(manifest);
...
const boundConditions={...context.conditions,sourceSha256:provenance.sourceManifest.sha256};
