...
mode=${1:?"usage: build-macos-capture-shim.zsh <library|policy-test|adaptive-policy-test|split-test|cursor-test|audio-ownership-test|tile-throughput-probe> <output>"}
