...
mode=${1:?"usage: build-macos-capture-shim.zsh <library|policy-test|adaptive-policy-test|split-test|cursor-test|audio-ownership-test|retransmit-ring-test|tile-throughput-probe> <output>"}
